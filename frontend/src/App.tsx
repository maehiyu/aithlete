...
import { SendHandlerContext, SendHandler } from './context/SendHandlerContext';
...
function AuthedApp() {
  ...
  const [handler, setHandler] = useState<SendHandler>(() => () => {});
  ...
  return (
    <Container maxWidth="sm" sx={{ mt: 4 }}>
      ...
      {!isLoading && currentUser && (
        <SendHandlerContext.Provider value={{handler, setHandler}}>
          <BrowserRouter>
            <Routes>
